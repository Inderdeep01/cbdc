...
function createOrgs() {
  ...
  infoln "Generating CCP files for RBI, HDFC and Axis"
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm compose_orderer.cbdc compose_peer0.rbi.cbdc compose_peer0.hdfc.bank.cbdc compose_peer0.axis.bank.cbdc
